...
class Gmail(object):
    ...
    # Calling logout can close either your IMAP connection or your SMTP
    # connection.  By default it closes both.
    ...
    # Send a gmail.Message object.  The only required field for the Message
    # is a to address.  If the from address is blank, the username you are
    # logged in is used.
    ...
    ## Return a message object for a given id.  Internal; using the library
    ## API shouldn't expose any message ids.
    def _fetch(self, id):
...
class Message(object):
    ...
    def from_address(self, addr=None):
        if addr is None:
            ...
            else: return self.download().from_address()
    ...
    def to_address(self, addr=None):
        if addr is None:
            ...
            else: return self.download().to_address()
    ...
    def subject(self, subj=None):
        if subj is None:
            ...
            else: return self.download().subject()
    ...
    def body(self, body=None):
        if body is None:
            ...
            else: return self.download().body()
